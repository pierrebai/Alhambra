...
#ifndef DAK_UTILITY_NUMBER_H
#define DAK_UTILITY_NUMBER_H
...
namespace dak
{
   namespace utility
   {
      ...
      inline bool near_less_or_equal(double a, double b)
      {
         return a <= (b + TOLERANCE);
      }
      ...
      inline bool near_greater_or_equal(double a, double b)
      {
         return a >= (b - TOLERANCE);
      }
