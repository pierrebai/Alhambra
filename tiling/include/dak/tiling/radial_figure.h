...
namespace dak
{
   namespace tiling
   {
      ...
      class radial_figure : public figure
      {
      public:
         int n = 6;

         radial_figure() : radial_figure(6) { }
         radial_figure(int n) : n(n) { }

         // Subclasses provide a method for getting the basic unit.
         // The unit *must* have a point at point::unit_x (1, 0).
         virtual map build_unit() const = 0;
